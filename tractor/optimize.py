...
#
# Changes in this fork are copyright (C) 2023-2026, California Institute of
# Technology:
#   2023-11-03  handle covariant errors
#   2024-07-28  updated, faster covariance matrix calculation
#   2024-08-26  updated covariance error calc with trimmed unit flux model
#   2025-08-25  Fix unit flux model starting indices
